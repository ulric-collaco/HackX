...
export default function Methodology() {
  ...
  useEffect(() => {
    document.title = "RetireReady | Methodology & Formulas";
         ...
         <div className="flex-1 p-8 space-y-12 max-w-5xl z-10">
            ...
            <div className="space-y-4">
               <p className="font-bold text-[#1E293B]/60 leading-relaxed text-lg italic">
                  "Every number in RetireReady is derived from real-world data and disclosed assumptions. No black boxes. No approximations."
               </p>
            </div>
            ...
            <div className="bg-[#FBBF24] border-2 border-[#1E293B] rounded-[24px] p-8 pop-shadow space-y-4">
               ...
               <div className="text-xs font-bold text-[#1E293B] leading-relaxed space-y-3 prose-strong:font-black">
                  <p>RetireReady provides financial projections for <strong>educational and planning purposes only</strong>. We are not a SEBI-registered investment advisor or an IRDAI-licensed agent.</p>
                  ...
                  <p className="border-t border-[#1E293B]/10 pt-4 uppercase tracking-widest text-[9px] opacity-70">RetireReady is an independent project and is not affiliated with PFRDA or the NPS Trust.</p>
               </div>
            </div>
